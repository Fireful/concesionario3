...
@Component({
  selector: 'jhi-coche-vendidos',
  templateUrl: './coche-vendidos.component.html'
})
export class CocheVendidosComponent implements OnInit, OnDestroy {
  coches?: ICoche[];
  ...
  protected onSuccess(data: ICoche[] | null, headers: HttpHeaders, page: number): void {
    ...
    this.page = page;
    this.router.navigate(['/coche/vendidos'], {
      queryParams: {
        page: this.page,
        size: this.itemsPerPage,
