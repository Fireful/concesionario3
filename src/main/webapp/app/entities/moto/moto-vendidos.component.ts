...
@Component({
  selector: 'jhi-moto-vendidos',
  templateUrl: './moto-vendidos.component.html'
})
export class MotoVendidosComponent implements OnInit, OnDestroy {
  motos?: IMoto[];
  ...
  protected onSuccess(data: IMoto[] | null, headers: HttpHeaders, page: number): void {
    ...
    this.page = page;
    this.router.navigate(['/moto/vendidos'], {
      queryParams: {
        page: this.page,
        size: this.itemsPerPage,
